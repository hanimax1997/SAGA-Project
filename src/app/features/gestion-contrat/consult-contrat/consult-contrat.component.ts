...
@Component({
  selector: 'app-consult-contrat',
  templateUrl: './consult-contrat.component.html',
  styleUrls: ['./consult-contrat.component.scss'],
  animations: [
...
export class ConsultContratComponent {
    ...
    this.contratService.getContratById(this.idContrat).subscribe({
      next: (datas: any) => {
        ...
        datas?.personnesList?.forEach((element: any) => {
          console.log('je cherche raison social',element)
          if(element.personne.raisonSocial==undefined ){
             element.personne.raisonSocial =null
          ...
          switch (element?.role?.code) {
            ...
            case 'CP234':
              ...
              console.log('je suis info sous',this.informationsSouscripteur)
            ...
            case 'CP238':
              ...
              case 'CP240':
                if(this.contrat.produit.codeProduit == "95"||this.contrat.produit.codeProduit == "96"){
                  this.informationsAssure = {
                    "typeClient": datas.typeClient.description,
                    "raisonSocial": element.personne.raisonSocial,
                    "nom": element.personne.nom,
