...
import { consultation_flotte } from './consultation-automobile-flotte';
import { Consultation } from '../consultation';

export interface AutomobileFlotte {
  police: string;
  assure: string;
  date_debut: Date;
  date_fin: Date;
...
const ELEMENT_DATA: AutomobileFlotte[] = [
...
export class ConsultationAutomobileFlotteComponent implements AfterViewInit  {

  displayedColumns: string[] = ['police', 'assure', 'date_debut', 'date_fin', 'mise_a_jour', 'statut', 'action'];
  dataSource: MatTableDataSource<AutomobileFlotte>;
  title: string = "Automobile flotte";
  consultations: Consultation[] = consultation_flotte;
