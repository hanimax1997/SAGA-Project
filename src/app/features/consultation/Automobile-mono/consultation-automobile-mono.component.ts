...
import { consultation_mono } from './consultation-automobile-mono';
import { Consultation } from '../consultation';

export interface AutomobileMono {
  police: string;
  assure: string;
  date_debut: Date;
  date_fin: Date;
...
const ELEMENT_DATA: AutomobileMono[] = [
...
export class ConsultationAutomobileMonoComponent implements AfterViewInit  {

  displayedColumns: string[] = ['police', 'assure', 'date_debut', 'date_fin', 'mise_a_jour', 'statut', 'action'];
  dataSource: MatTableDataSource<AutomobileMono>;
  title: string = "Automobile mono";
  consultations: Consultation[] = consultation_mono;
