...
@Component({
  selector: 'app-consult-devis',
  templateUrl: './consult-devis.component.html',
  styleUrls: ['./consult-devis.component.scss'],
  animations: [
...
export class ConsultDevisComponent implements OnInit {
  wilayas: any;
  risqueWilayaId: any;
