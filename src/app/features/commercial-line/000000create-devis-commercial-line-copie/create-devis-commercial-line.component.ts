...
// getdureeTransport(typePolice: any) {
//   console.log('typePolice le voila', typePolice);

//   this.dureeService.getDureeByIdProduit(this.idProduit).subscribe({
//     next: (data: any) => {
//       console.log('la liste intial de duree', data);

//       switch (typePolice) {
//         case "TP01":
//           this.listDuree = []; // 🟢 On initialise ici
//           data.map((el: any) => {
//             console.log('on est les element du coup duree', el);
//             if (el.duree.code == "D04")
//               this.listDuree.push(el);
//           });
//           break;
...
//       console.log('la liste apres filtre', this.listDuree);
//       this.duree = this.listDuree;
//     },
//     error: (error) => {
//       console.log(error);
//     }
...
this.risqueArray=this.paraRisqueProduitCategory[1]
